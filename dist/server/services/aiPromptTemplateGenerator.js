function injectContext(template, input) {
    return template
...
- 显示参考来源
`;
export function generateWritingPrompt(input) {
    return {
        type: 'writing',
        filename: 'writing.md',
...
export function generateReadingPrompt(input) {
    return {
        type: 'reading',
        filename: 'reading.md',
...
export function generateRetrievalPrompt(input) {
    return {
        type: 'retrieval',
...
export function generateCommandPrompt(input) {
    return {
        type: 'command',
        filename: 'command.md',
...
export function generateAllAiPrompts(input) {
    return [
